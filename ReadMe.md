...
First you define what the form looks like and what type of data it should expect using a schema. Then you prepare it to catch errors if the data is not the correct form or what is expected.

3. In 1-2 sentences, define end to end testing.

End to End testing basically mimics a User and can test any possible interaction the User may have with the App from start to finish.
